...
class InternalGUI(OpenShift):
    """
    internal-gui lab script for DO370
    """
    __LAB__ = "internal-gui"
    ...
    def start(self):
        ...
        items = [
            ...
            },
            {
                ...
                "vars": {"exercise": "{{ exercises['internal_gui'] }}"},
                "fatal": True
            },
        ]
