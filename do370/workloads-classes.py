...
"""
Grading module for DO370 workloads-classes guided exercise (or lab).
...
class WorkloadsClasses(OpenShift):
    """
    Workloads Classes lab script for DO370
    """
    __LAB__ = "workloads-classes"
    ...
    def _delete_ge_namespace(self, item):
        item["failed"] = False
        try:
            self.delete_resource("v1", "Namespace", "workloads-classes-ge", "")
        except Exception as e:
            item["failed"] = True
    ...
    def _check_ge_namespace(self, item):
        ...
        """
        item["failed"] = False
        if self.resource_exists("v1", "Namespace", "workloads-classes-ge", ""):
            item["failed"] = True
            item["msgs"] = [{"text":
                "The workloads-classes-ge namespace already exists, please " +
                "delete it or run 'lab finish workloads-classes' " +
