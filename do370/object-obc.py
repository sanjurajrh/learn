...
#
# CHANGELOG
# Apr 14 2021 Andres Hernandez <andres.hernandez@redhat.com>
#   - Original code
# Oct 05 2021 Andres Hernandez <andres.hernandez@redhat.com>
#   - Fixes for release/ODF4.7

"""
Grading module for DO370 object-obc guided exercise.

This module implements the start, grading, and finish actions for the
object-obc guided exercise.
"""
...
NAMESPACE = "obc-practice"

disable_warnings(InsecureRequestWarning)

# Change the class name to match your file name
class ObjectObc(OpenShift):
    """
    object-obc lab script for DO370
    """
    __LAB__ = "object-obc"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Configure lab tools",
                "task": self._start_prepare_tools,
            },
            {
    ...
    def _start_prepare_tools(self, package):
        subprocess.run(
        ...
        for package in ["awscli", "awscli-plugin-endpoint"]:
            subprocess.run(
