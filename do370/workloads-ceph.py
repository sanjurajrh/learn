...
#
# CHANGELOG
#   * Fri Jul 02 2021 Iván Chavero ichavero@redhat.com
#   - original code
#   * Aug 20, 2021 Austin Garrigus <agarrigu@redhat.com>
#   - modified for workloads-ceph

"""
Grading module for DO370 workloads-ceph guided exercise (or lab).
...
class WorkloadsCeph(OpenShift):
    """
    Workloads Ceph lab script for DO370
    """
    __LAB__ = "workloads-ceph"
    ...
    def _delete_ge_namespace(self, item):
        item["failed"] = False
        try:
            self.delete_resource("v1", "Namespace", "workloads-ceph-ge", "")
        except Exception as e:
            item["failed"] = True
    ...
    def _check_ge_namespace(self, item):
        ...
        """
        item["failed"] = False
        if self.resource_exists("v1", "Namespace", "workloads-ceph-ge", ""):
            item["failed"] = True
            item["msgs"] = [{"text":
                "The workloads-ceph-ge namespace already exists, please " +
                "delete it or run 'lab finish workloads-ceph' " +
