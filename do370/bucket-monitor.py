...
#
# CHANGELOG
# Jun 03 2021 Andres Hernandez <andres.hernandez@redhat.com>
#   - original code

"""
Grading module for DO370 bucket-monitor guided exercise.

This module implements the start, grading, and finish actions for the
bucket-monitor guided exercise (or lab).
"""
...
class BucketMonitor(OpenShift):
    """
    bucket-monitor lab script for DO370
    """
    __LAB__ = "bucket-monitor"
