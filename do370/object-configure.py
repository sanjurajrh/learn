...
"""
Grading module for DO370 object-configure guided exercise.

This module implements the start, grading, and finish actions for the
object-configure guided exercise (or lab).
"""
...
NAMESPACE = "image-tool-s3-obc"

disable_warnings(InsecureRequestWarning)

# Change the class name to match your file name
class ObjectConfigure(OpenShift):
    """
    object-configure lab script for DO370
    """
    __LAB__ = "object-configure"
