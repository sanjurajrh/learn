...
#
# CHANGELOG
# Apr 27 2021 Andres Hernandez <andres.hernandez@redhat.com>
#   - original code

"""
Grading module for DO370 workloads-file guided exercise.

This module implements the start, grading, and finish actions for the
workloads-file guided exercise.
"""
...
NAMESPACE = "image-tool"

disable_warnings(InsecureRequestWarning)

# Change the class name to match your file name
class WorkloadsFile(OpenShift):
    """
    workloads-file lab script for DO370
    """
    __LAB__ = "workloads-file"
