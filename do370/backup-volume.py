...
#
# CHANGELOG
# Jul 16 2021 Andres Hernandez <andres.hernandez@redhat.com>
#   - original code

"""
Grading module for DO370 backup-volume guided exercise.

This module implements the start, grading, and finish actions for the
backup-volume guided exercise.
"""
...
class BackupVolume(OpenShift):
    """
    backup-volume lab script for DO370
    """
    __LAB__ = "backup-volume"
